...
class Datahub {
    ...
    */
     ...
     * @param {String} shardId 
     * @param {Number} sequenceOrSystemTime
     * @example
     ...
     */
    getCursor(projectName, topicName, cursorType = CursorType.OLDEST, shardId = '0', sequenceOrSystemTime = null) {
        return this.rest.request('POST', `/projects/${projectName}/topics/${topicName}/shards/${shardId}`, {
            Action: 'cursor',
            Type: cursorType,
            Sequence: cursorType === CursorType.SEQUENCE ? sequenceOrSystemTime : null,
            SystemTime: cursorType === CursorType.SYSTEM_TIME ? sequenceOrSystemTime : null
        })
    }
