...
class RecordSchema {
     ...
     */
    constructor(fields) {
        // TODO check constructor is Field or Array
...
class ConnectorType { }
ConnectorType.SINK_ODPS = 'sink_odps'
ConnectorType.SINK_ADS = 'sink_ads'
ConnectorType.SINK_ES = 'sink_es'
ConnectorType.SINK_FC = 'sink_fc'
ConnectorType.SINK_MYSQL = 'sink_mysql'
ConnectorType.SINK_OSS = 'sink_oss'
ConnectorType.SINK_OTS = 'sink_ots'
ConnectorType.SINK_DATAHUB = 'sink_datahub'
