...
class RestClient {
     ...
     * @function request 
     */
    constructor(baseURL, accessKeyId, accessKeySecret, axiosOptions) {
        this.client = axios.create({
            baseURL,
            timeout: axiosOptions.timeout || 2000,
        });
     ...
     * @param {String} url 
     * @param {Object>} data 
     * @return {Promise<{status: Number ;statusText: String ;data: Object;}>}
     */
